...
from api.dashboard.mentor.serializers import *
from django.contrib.auth import get_user_model

User = get_user_model()


class MentorView(generics.RetrieveUpdateAPIView):
    """View To View Or Update User Profile"""
    serializer_class = MentorSerializer
    queryset = User.objects.all()
    permission_classes = (IsAuthenticated, UserIsMentorOrReadOnly,)
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer = MentorSerializer(instance, data=request.data)
